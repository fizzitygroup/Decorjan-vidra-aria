          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#25D366] hover:bg-[#1dba58] text-white px-8 py-4 rounded-full font-bold text-lg transition-all shadow-xl hover:scale-105 flex items-center justify-center gap-3 group"
              >
      ...
      <section className="py-12 bg-navy text-white">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center max-w-2xl mx-auto">
            <div>
              <p className="text-3xl md:text-4xl font-bold text-decor-red mb-1">+ de 30 anos</p>
